...
public class InvoicePrinter {
	...
	public static void printReport(Invoices invoices) {
		...
		//Loop through all the invoices, then sum up the costs of all their products and display.
		...
		//Loop through the invoices one by one and give detailed information.
		for(Invoice invoiceB : invoices.getList()){
			...
			//Display all the products in the invoice, and their information/costs.
